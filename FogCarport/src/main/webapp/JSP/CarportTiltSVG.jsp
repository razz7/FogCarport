...
<%
    ...
    //Order order = new Order(1, 6060, 7300, 2300, 30, 0, 0);
...
<div>
    <svg width="<% out.println(order.getWidth() / 10); %>" height="<% out.println(((order.getHeight() + (Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2))) / 10) + 30); %>">
    ...
    %>
    <rect x="0" y="-30" height=" <% out.println(((Math.tan(order.getRoofTilt() * Math.PI / 180) * materials.get(23).getHeight()) / 10) + (materials.get(23).getHeight()) / 10); %> " width=" <% out.println(materials.get(7).getHeight() / 10); %> " transform="translate( <% out.println(((materials.get(23).getWidth()) + sum4) / 10); %> , <% out.println(((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2))) / 10); %>) scale(1,-1)" stroke="black" fill="blue"/>
    <%
        if (order.getShedLength() != 0 || order.getShedWidth() != 0) {
    ...
    %>
    <rect x=" <% out.println((((order.getWidth() - order.getShedWidth()) / 2) + sum3) / 10); %> " y=" <% out.println((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2))) / 10) + 30); %> " height=" <% out.println(((materials.get(6).getLength() - 900) / 10)); %> " width=" <% out.println(materials.get(7).getHeight() / 10); %> " stroke="black" fill="blue"/>
    <%
            sum3 += 60;
        }
    %>
    <rect x=" <% out.println(((order.getWidth() - order.getShedWidth()) / 2) / 10); %> " y=" <% out.println((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2))) / 10) + 30); %> " height=" <% out.println(((materials.get(6).getLength() - 900) / 10)); %> " width=" <% out.println(materials.get(6).getWidth() / 10); %> " stroke="black" fill="red"/>
    <rect x=" <% out.println((order.getWidth() - materials.get(6).getWidth() - ((order.getWidth() - order.getShedWidth()) / 2)) / 10); %> " y=" <% out.println((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2))) / 10) + 30); %> " height=" <% out.println(((materials.get(6).getLength() - 900) / 10)); %> " width=" <% out.println(materials.get(6).getWidth() / 10); %> " stroke="black" fill="red"/>
    <rect x='0' y=' 0 ' width='<% out.println(((order.getWidth() / 2 / Math.sin((180 - 90 - order.getRoofTilt()) * Math.PI / 180)) - 30) / 10); %>' height='<% out.println((materials.get(23).getHeight()) / 10);%>' transform='translate(<% out.println(materials.get(23).getWidth() / 10 / 2); %>, <% out.println(((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2))) - materials.get(23).getHeight() - (materials.get(23).getHeight())) / 10) + 30);%>) rotate( <% out.println(-order.getRoofTilt());%> ) skewX(-30)' stroke="black" fill="red"/>
    <rect x='0' y=' 0 ' width='<% out.println(((order.getWidth() / 2 / Math.sin((180 - 90 - order.getRoofTilt()) * Math.PI / 180)) - 30) / 10); %>' height='<% out.println((materials.get(23).getHeight()) / 10);%>' transform='translate(<% out.println((order.getWidth() - materials.get(23).getWidth()) / 10); %>, <% out.println(((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2))) + materials.get(23).getWidth() - (materials.get(23).getHeight())) / 10) + 30);%>) rotate( <% out.println(180 + order.getRoofTilt());%> ) skewX(30)' stroke="black" fill="red"/>
    <rect x='0' y='<% out.println((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2)) - (materials.get(23).getHeight())) / 10) + 30); %>' width='<% out.println((materials.get(23).getWidth()) / 10); %>' height='<% out.println((materials.get(23).getHeight()) / 10); %>' stroke="black" fill="red"/>
    <rect x='<% out.println((order.getWidth() - materials.get(23).getWidth()) / 10); %>' y='<% out.println((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2)) - (materials.get(23).getHeight())) / 10) + 30); %>' width='<% out.println((materials.get(23).getWidth()) / 10); %>' height='<% out.println((materials.get(23).getHeight()) / 10); %>' stroke="black" fill="red"/>
    <rect x=" <% out.println(((order.getWidth() - order.getShedWidth()) / 2) / 10); %> " y=" <% out.println((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2))) / 10) + 30); %> " height=" <% out.println(((materials.get(5).getHeight()) / 10)); %> " width=" <% out.println(materials.get(5).getWidth() / 10); %> " stroke="black" fill="green"/>
    <rect x=" <% out.println((order.getWidth() - materials.get(5).getWidth() - ((order.getWidth() - order.getShedWidth()) / 2)) / 10); %> " y=" <% out.println((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2))) / 10) + 30); %> " height=" <% out.println(((materials.get(5).getHeight()) / 10)); %> " width=" <% out.println(materials.get(5).getWidth() / 10); %> " stroke="black" fill="green"/>
    <%
    } else {
    %>
    <rect x=" <% out.println((((700) / 2)) / 10); %> " y=" <% out.println((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2))) / 10) + 30); %> " height=" <% out.println(((materials.get(6).getLength() - 900) / 10)); %> " width=" <% out.println(materials.get(6).getWidth() / 10); %> " stroke="black" fill="red"/>
    <rect x=" <% out.println((order.getWidth() - materials.get(6).getWidth() - ((700) / 2)) / 10); %> " y=" <% out.println((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2))) / 10) + 30); %> " height=" <% out.println(((materials.get(6).getLength() - 900) / 10)); %> " width=" <% out.println(materials.get(6).getWidth() / 10); %> " stroke="black" fill="red"/>
    <rect x='0' y=' 0 ' width='<% out.println(((order.getWidth() / 2 / Math.sin((180 - 90 - order.getRoofTilt()) * Math.PI / 180)) - 30) / 10); %>' height='<% out.println((materials.get(23).getHeight()) / 10);%>' transform='translate(<% out.println(materials.get(23).getWidth() / 10 / 2); %>, <% out.println(((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2))) - materials.get(23).getHeight() - (materials.get(23).getHeight())) / 10) + 30);%>) rotate( <% out.println(-order.getRoofTilt());%> ) skewX(-30)' stroke="black" fill="red"/>
    <rect x='0' y=' 0 ' width='<% out.println(((order.getWidth() / 2 / Math.sin((180 - 90 - order.getRoofTilt()) * Math.PI / 180)) - 30) / 10); %>' height='<% out.println((materials.get(23).getHeight()) / 10);%>' transform='translate(<% out.println((order.getWidth() - materials.get(23).getWidth()) / 10); %>, <% out.println(((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2))) + materials.get(23).getWidth() - (materials.get(23).getHeight())) / 10) + 30);%>) rotate( <% out.println(180 + order.getRoofTilt());%> ) skewX(30)' stroke="black" fill="red"/>
    <rect x='0' y='<% out.println((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2)) - (materials.get(23).getHeight())) / 10) + 30); %>' width='<% out.println((materials.get(23).getWidth()) / 10); %>' height='<% out.println((materials.get(23).getHeight()) / 10); %>' stroke="black" fill="red"/>
    <rect x='<% out.println((order.getWidth() - materials.get(23).getWidth()) / 10); %>' y='<% out.println((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2)) - (materials.get(23).getHeight())) / 10) + 30); %>' width='<% out.println((materials.get(23).getWidth()) / 10); %>' height='<% out.println((materials.get(23).getHeight()) / 10); %>' stroke="black" fill="red"/>
    <rect x=" <% out.println(((700) / 2) / 10); %> " y=" <% out.println((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2))) / 10) + 30); %> " height=" <% out.println(((materials.get(5).getHeight()) / 10)); %> " width=" <% out.println(materials.get(5).getWidth() / 10); %> " stroke="black" fill="green"/>
    <rect x=" <% out.println((order.getWidth() - materials.get(5).getWidth() - ((700) / 2)) / 10); %> " y=" <% out.println((((Math.tan(order.getRoofTilt() * Math.PI / 180) * (order.getWidth() / 2))) / 10) + 30); %> " height=" <% out.println(((materials.get(5).getHeight()) / 10)); %> " width=" <% out.println(materials.get(5).getWidth() / 10); %> " stroke="black" fill="green"/>
    <%
        }
    %>
    </svg>
