...
<%
    if (session.getAttribute("width") != null && session.getAttribute("shedWidth") != null && session.getAttribute("length") != null && session.getAttribute("shedLength") != null) {
        ...
        out.println("<rect x=\"100\" y=\"30\" width=\"30\" height=\"500\" style=\"stroke: #000000; fill: #FF0000;\"/>");
        //out.println("<rect x=\"100\" y=\"30\" width=\"30\" height=\"500\" style=\"stroke: #000000; fill: #0033cc;\"/>");
