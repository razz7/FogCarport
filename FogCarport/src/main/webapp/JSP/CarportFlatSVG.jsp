...
<html>
    ...
    <body>
        ...
        <div>
            ...
            %>
            <rect x=" <% out.println(((((order.getWidth() - order.getShedWidth()) / 2) / Math.sin(45 * Math.PI / 180)) + 180) / 10); %> " y=" -20" height=" <% out.println((materials.get(10).getHeight() / 10)); %> " width=" <% out.println(((order.getWidth() - ((order.getWidth() - order.getShedWidth()))) / Math.sin(45 * Math.PI / 180)) / 10);%> " transform='rotate( 45 )'  />
            <rect x=" <% out.println(((((order.getWidth() - order.getShedWidth()) / 2) / Math.sin(45 * Math.PI / 180)) - 4060) / 10); %> " y=" 440" height=" <% out.println((materials.get(10).getHeight() / 10)); %> " width=" <% out.println(((order.getWidth() - ((order.getWidth() - order.getShedWidth()))) / Math.sin(45 * Math.PI / 180)) / 10);%> " transform='rotate( 315 )'  />
            </svg>
        </div>
