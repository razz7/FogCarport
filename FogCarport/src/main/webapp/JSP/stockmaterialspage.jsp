        ...
        <%
            if (session.getAttribute("stockMaterialList") != null) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    out.println("<h5>" + list.get(i).getItem_id() + ", " + list.get(i).getItem_description() + ", " + list.get(i).getWidth() + ", " + list.get(i).getHeight() + ", " + list.get(i).getEntity() + ", " + list.get(i).getMaterialType() + ", " + list.get(i).getPrice() + "</h5>");                    
